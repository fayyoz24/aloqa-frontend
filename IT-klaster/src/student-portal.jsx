...
const css = {
  ...
  page: {
    minHeight: "100vh",
    background: `linear-gradient(160deg, ${COLORS.navy} 0%, ${COLORS.navyMid} 60%, #0D2B5E 100%)`,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            {filtered.map((s) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: "bold", fontSize: "15px", color: COLORS.navy }}>
                ...
                <span style={{ color: COLORS.blue, fontSize: "18px" }}>→</span>
              </div>
            ))}
            {filtered.length === 0 && (
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: "100%", maxWidth: "380px", boxShadow: "0 32px 80px rgba(0,0,0,0.5)",
      }}>
        ...
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <button onClick={() => onConfirm(pw)} style={{ ...css.btn, ...css.btnPrimary, flex: 1, justifyContent: "center" }}>
            Kirish
          </button>
          <button onClick={onCancel} style={{ ...css.btn, ...css.btnOutline, flex: 1, justifyContent: "center", color: COLORS.navy, border: `1px solid ${COLORS.border}` }}>
            Bekor
          </button>
        </div>
      </div>
      ...
      <div style={css.lightPage}>
        ...
        <div style={{ maxWidth: "860px", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: "1.5rem", marginBottom: "2rem", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1 }}>
              <h1 style={{ margin: 0, fontSize: "24px", color: COLORS.navy }}>{fullName}</h1>
              ...
              {docs.map((d) => (
                <div key={d.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.75rem 1rem", background: COLORS.surface, borderRadius: "8px", border: `1px solid ${COLORS.border}`, marginBottom: "0.5rem" }}>
                  ...
                  <button
                    ...
                    style={{ ...css.btn, ...css.btnPrimary, fontSize: "12px", padding: "0.4rem 0.9rem" }}
                  >
                    ⬇ Yuklab olish
                  </button>
                </div>
